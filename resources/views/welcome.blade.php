                                ...
                                <div class="card card-xl-stretch mb-xl-8">
                                    ...
                                    <div class="card-body pt-2">
                                        ...
                                        <div class="d-flex align-items-center mb-8">
                                            ...
                                            <span class="badge badge-light-success fw-bolder">pool.youcloud.ru:20032</span>
                                        ...
                                        <div class="d-flex align-items-center mb-8">
                                            ...
                                            <span class="badge badge-light-info fw-bolder"><a class="text-hover-primary" href="https://github.com/trexminer/T-Rex/releases">T-Rex</a></span>

                                            <span class="badge badge-light-info fw-bolder"><a class="text-hover-primary" href="https://www.bzminer.com/">BzMiner</a></span>
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <div class="d-flex align-items-center mb-8">
                                            ...
                                            <!--begin::Description-->
                                            <div class="flex-grow-1">
                                                <div class="text-gray-800  fw-bolder fs-6">Dual Miner (ETH+ALPH) 100% LHR!!!!!</div>
                                            </div>
                                            <span class="badge badge-light-info fw-bolder"><a class="text-hover-primary" href="https://github.com/trexminer/T-Rex/releases">Instruction</a></span>
                                    ...
                                    <div class="card-body pt-5">
                                        ...
                                        <div class="timeline-label">
                                            ...
                                            <div class="timeline-item">
                                                ...
                                                <!--end::Badge-->
                                                <!--begin::Text-->
                                                <div class="fw-mormal timeline-content text-muted ps-3">06 Febrasdasdsadsa saduary</div>
                                                <!--end::Text-->
                                            </div>
                                            <!--end::Item-->
                                            <!--begin::Item-->
                        ...
                        <div class="g-5 gx-xxl-8">
                            ...
                            <div class="col-xxl-12 card mb-5 mb-xl-12">
                                ...
                                <div class="card-header border-0 pt-5">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bolder fs-3 mb-1">Last blocks</span>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end text-dark fw-bolder text-hover-primary fs-6">$3560</td>
